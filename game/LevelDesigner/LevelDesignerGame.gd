...
func _on_level_complete_timer_timeout():
	...
	if level_number == 5:
		self.level_complete_controls_center_container.find_child('NextLevelButton').hide() # Might conflict with DailyGame, who knows
		self.level_complete_controls_center_container.find_child('NextLevelButton').text = "Demo Complete <3"
