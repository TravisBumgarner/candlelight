...
func _ready():
	if GlobalState.game_mode == GlobalConsts.GAME_MODE.ApprenticeshipGame:
	...
	if GlobalState.game_mode == GlobalConsts.GAME_MODE.PuzzleGame:
		game = PuzzleGame.new(
		board_tile_map, 
		target_gem_tile_map, 
		queue_tile_map, 
	...
	if GlobalState.game_mode == GlobalConsts.GAME_MODE.DailyGame:
		game = DailyGame.new(
		board_tile_map, 
		target_gem_tile_map, 
		queue_tile_map, 
